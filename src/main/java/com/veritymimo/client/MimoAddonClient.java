...
public final class MimoAddonClient {
    ...
    public static Screen createConfigScreen(Screen parent) {
        ...
        general.addEntry(entryBuilder.startStrField(Component.m_237113_("MiMo API Key"), MimoAddonConfig.MIMO_API_KEY.get()).setDefaultValue("").setTooltip(Component.m_237113_("API key from https://platform.xiaomimimo.com/#/console/api-keys. Pay-as-you-go keys start with sk-, Token Plan keys with tp-.")).setSaveConsumer(arg_0 -> MimoAddonConfig.MIMO_API_KEY.set(arg_0)).build());
        general.addEntry(entryBuilder.startEnumSelector(Component.m_237113_("MiMo Plan"), MimoAddonConfig.MimoPlan.class, MimoAddonConfig.MIMO_PLAN.get()).setDefaultValue(MimoAddonConfig.MimoPlan.PAYG).setEnumNameProvider(provider -> Component.m_237113_(((MimoAddonConfig.MimoPlan) provider).displayName())).setTooltip(Component.m_237113_("\u6309\u91cf\u4ed8\u8d39 (sk- keys) or Token Plan (tp- keys)")).setSaveConsumer(arg_0 -> MimoAddonConfig.MIMO_PLAN.set(arg_0)).build());
        general.addEntry(entryBuilder.startEnumSelector(Component.m_237113_("MiMo Cluster (Token Plan)"), MimoAddonConfig.MimoCluster.class, MimoAddonConfig.MIMO_CLUSTER.get()).setDefaultValue(MimoAddonConfig.MimoCluster.CN).setEnumNameProvider(provider -> Component.m_237113_(((MimoAddonConfig.MimoCluster) provider).displayName())).setTooltip(Component.m_237113_("\u4e2d\u56fd / \u65b0\u52a0\u5761 / \u6b27\u6d32 — only used when plan is Token Plan")).setSaveConsumer(arg_0 -> MimoAddonConfig.MIMO_CLUSTER.set(arg_0)).build());
        ...
        general.addEntry(entryBuilder.startEnumSelector(Component.m_237113_("MiMo Voice Mode"), MimoAddonConfig.VoiceMode.class, MimoAddonConfig.MIMO_VOICE_MODE.get()).setDefaultValue(MimoAddonConfig.VoiceMode.MIMO_PRESET).setEnumNameProvider(provider -> Component.m_237113_(((MimoAddonConfig.VoiceMode) provider).displayName())).setTooltip(Component.m_237113_("MIMO_PRESET: use the preset voice above. VERITY_CLONE: clone Verity's in-game voice from the bundled intro sample (mimo-v2.5-tts-voiceclone).")).setSaveConsumer(arg_0 -> MimoAddonConfig.MIMO_VOICE_MODE.set(arg_0)).build());
        general.addEntry(entryBuilder.startStrField(Component.m_237113_("MiMo TTS Voice"), MimoAddonConfig.MIMO_TTS_VOICE.get()).setDefaultValue("\u82cf\u6253").setTooltip(Component.m_237113_("Chinese male: \u82cf\u6253 (Soda) / \u767d\u6866 (Baihua). Chinese female: \u51b0\u7cd6 (Bingtang) / \u8309\u8389 (Moliy). English: Mia, Chloe, Milo, Dean. (only used in MiMo preset voice mode)")).setSaveConsumer(arg_0 -> MimoAddonConfig.MIMO_TTS_VOICE.set(arg_0)).build());
